...
public class GameDrunkard extends JFrame {
    ...
    private void initWindow() {
        ...
        cardsLeft1 = new JLabel("Remaining number of cards: " + cards.getNumOfFirstPlayerCards());
        cardsLeft2 = new JLabel("Remaining number of cards: " + cards.getNumOfSecondPlayerCards());
    ...
    private void showLeftCards() {
        cardsLeft1.setText("Remaining number of cards: " + cards.getNumOfFirstPlayerCards());
        cardsLeft2.setText("Remaining number of cards: " + cards.getNumOfSecondPlayerCards());
    }
}
